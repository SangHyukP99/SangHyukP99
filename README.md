...
| :--- | :--- | :--- | :--- |
| **Project** | C , UART | 3층 소형 엘레베이터 시스템 구현 |   엘리베이터 층별(외부 패널) 제어 / 입력 출력 인터페이스 개발 사용자가 직접 조작하는 층별 호출 입력(키패드)와 도어 개폐 출력(서보모터)파트를 담당 STM32 블루필 기반 해당 노드의 입력 처리 및 액추에이터 제어 구현 |
